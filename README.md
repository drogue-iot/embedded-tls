...
>
> Development of `embedded-tls` continues at
> [embassy-rs/embedded-tls](https://github.com/embassy-rs/embedded-tls).
> Please file issues, open pull requests and follow releases there.
