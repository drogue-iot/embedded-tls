...
/// The ephemeral key share generated by the client for a single named group,
/// covering plain classical groups as well as the hybrid post-quantum groups
/// that pair a classical ECDH/X25519 secret with an ML-KEM-768 decapsulation key.
pub enum KeyExchangeSecret {
    #[cfg(all(not(feature = "x25519"), not(feature = "mlkem")))]
    ...
    Secp256r1MlKem768(p256::ecdh::EphemeralSecret, DecapsulationKey<MlKem768>),
    #[cfg(all(feature = "mlkem", feature = "x25519"))]
    X25519MlKem768(x25519_dalek::EphemeralSecret, DecapsulationKey<MlKem768>),
}
    ...
    CipherSuite: TlsCipherSuite,
{
    ...
    secret: Option<KeyExchangeSecret>,
