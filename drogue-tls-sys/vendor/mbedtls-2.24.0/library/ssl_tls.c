                               ...
                               const mbedtls_ssl_context *ssl )
{
    ...
    MBEDTLS_SSL_DEBUG_MSG( 2, ( "DROGUE-A" ) );
    ...
    {
        MBEDTLS_SSL_DEBUG_MSG( 2, ( "DROGUE-B" ) );
...
#endif
    {
        MBEDTLS_SSL_DEBUG_MSG( 2, ( "DROGUE-C" ) );
        ret = handshake->tls_prf( handshake->premaster, handshake->pmslen,
                                  lbl, salt, salt_len,
                                  master,
                                  master_secret_len );
        MBEDTLS_SSL_DEBUG_MSG( 2, ( "DROGUE-C2" ) );
        if( ret != 0 )
        {
        MBEDTLS_SSL_DEBUG_MSG( 2, ( "DROGUE-C3" ) );
            MBEDTLS_SSL_DEBUG_RET( 1, "prf", ret );
            return( ret );
        }

        MBEDTLS_SSL_DEBUG_MSG( 2, ( "DROGUE-C4" ) );
        MBEDTLS_SSL_DEBUG_BUF( 3, "premaster secret",
                               handshake->premaster,
                               handshake->pmslen );

        MBEDTLS_SSL_DEBUG_MSG( 2, ( "DROGUE-C5" ) );
